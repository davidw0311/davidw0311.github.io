...
function prepare(ctx) {
  ...
  if (included.has("empath")) st.publicRules.push(pair(({ viewed: "Empath asks everyone whether they viewed a card during a night action.", moved: "Empath asks everyone whether they moved any card tonight.", evil: "Empath asks everyone whether they started as a werewolf, vampire, alien or villain." })[st.empathQuestion], ({ viewed: "共情者询问大家是否在夜间行动中查看过身份牌。", moved: "共情者询问大家今晚是否移动过身份牌。", evil: "共情者询问大家最初是否为狼人、吸血鬼、外星人或反派。" })[st.empathQuestion]));
