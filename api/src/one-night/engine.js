...
function descriptor(room, seat) {
    ...
    if (role === 'robber') return base('Exchange your card with another player and see your new card.', '与另一位玩家交换牌，并查看自己的新牌。', room.shields.includes(seat.id) ? [] : cards(others), 1, 1, true);
    if (role === 'troublemaker') return base('Exchange two other players’ cards without looking.', '交换两位其他玩家的牌，不得查看。', cards(others), 2, 2, true);
