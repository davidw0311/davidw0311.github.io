...
With Sheriff enabled, the end of the first night automatically opens nominations before resolving or exposing overnight deaths. Every seated player chooses whether to run. Candidates speak in seat order and finish their own turns. They may withdraw (退水) during nominations, speeches, or voting. Everyone who ran is excluded from voting, including withdrawn candidates. Only non-candidates vote for remaining candidates; withdrawal clears votes for that candidate so those voters can choose again. All eligible submissions count the ballot automatically. No candidates, no eligible voters, or a tied Sheriff ballot means no badge. There is no host-controlled election launch. Host hard skips remain available for disconnected players.
