...
): languageId is Extract<LanguageId, "zh" | "zht" | "yue" | "ja" | "ko"> {
  return languageId === "zh" || languageId === "zht" || languageId === "yue" || languageId === "ja" || languageId === "ko";
}

function characterStudyToken(
  character: string,
  languageId: Extract<LanguageId, "zh" | "zht" | "yue" | "ja" | "ko">,
