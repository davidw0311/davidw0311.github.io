...
function Footer() {
  return <footer className={s.footer}><div className={s.footerInvite}><h2>Let’s make<br />your home, yours.</h2><Button page="contact">Start a conversation</Button></div><div className={s.footerBottom}><Link href={href('v3')} className={s.brand} aria-label={brandName}>Firestar<span>（infinite） granite</span></Link><div><a href="tel:+12507291447">250-729-1447</a><a href="tel:+12506199968">250-619-9968</a><a href="mailto:sales@infinitegranite.ca">sales@infinitegranite.ca</a><span>Fax: 250-740-1046</span></div><address>2156 Akenhead Road<br />Nanaimo, BC V9X 1T9</address><Link href="/#projects">Back to projects ↗</Link></div><small>Copyright 2023 Infinitegranite.ca</small></footer>;
}
