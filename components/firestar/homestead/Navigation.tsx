...
export function HomesteadNavigation({ current }: { current: PageKey }) {
  ...
  return <><div className={s.contactStrip}><span>Your local stone people. Nanaimo, BC.</span><a href="tel:+12507291447">Let’s talk: 250-729-1447</a></div><header className={s.header}>
