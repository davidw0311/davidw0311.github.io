...
function Home() {
  return <>
    ...
    <About /><section className={s.visitBanner}><div><p className={s.kicker}>Two places to begin</p><h2>SEE THE<br />POSSIBILITIES.</h2></div><div><p>Full slabs. Showroom samples. Your ideas.</p><LinkButton page="showroom">Visit our showrooms</LinkButton><a href="tel:+12506199968">250-619-9968</a></div></section>
  </>;
}
function Services() {
...
function Footer() {
  return <footer className={s.footer}><div><strong>{brandName}</strong><span>Individual service. Superior craftsmanship.</span></div><div><a href="mailto:sales@infinitegranite.ca">sales@infinitegranite.ca</a><a href="tel:+12506199968">250-619-9968</a></div><p>2156 Akenhead Road, Nanaimo, BC V9X 1T9</p><small>Copyright 2023 Infinitegranite.ca</small><Link href="/#projects">Back to projects ↗</Link></footer>;
}
