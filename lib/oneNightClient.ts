...
export type Seat = { id: string; name: string; number: number; photo?: string | null; ready: boolean; connected: boolean; occupied: boolean; host?: boolean; isHost?: boolean; roleId?: string; originalRoleId?: string; finalRoleId?: string; mark?: string; revealedRoleId?: string };
