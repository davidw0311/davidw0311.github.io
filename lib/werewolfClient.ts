...
export type Seat = { id: string; name: string; isBot?: boolean; photo?: string | null; ready?: boolean; connected: boolean; occupied: boolean; alive: boolean; isHost: boolean; isSheriff: boolean; canVote: boolean; silenced?: boolean; roleId?: string; team?: string };
