...
export type GameView = {
  ...
  election?: { candidateIds: string[]; withdrawnIds: string[]; declaredIds: string[]; voterIds: string[] } | null; lastNight?: {night: number; eliminatedSeatIds: string[]; numbers: number[]} | null;
