...
export default function WerewolfApp() {
  ...
  const [modal, setModal] = useState<"library" | "settings" | "people" | "recovery" | "rules" | "leave" | "invite" | "hardSkip" | null>(null);
