...
import roles from './expansion-roles.json' with {type:'json'};
...
export { roles,ORDERS as orders, ALIENS, VILLAINS, BONUS_ARTIFACTS, ADAPTATION, prepare, initialize, effective, augmentSchedule,getActors as actors, getActors, buildAction, perform, beforeVote, replaceDeaths, afterVote,afterVote as resolve};
