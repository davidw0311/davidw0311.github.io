...
The Language Lab keeps its MVP lesson catalog and 782 Azure neural voice clips in the static site. It includes normal and slow sentence readings plus each tappable phrase in English, Mandarin, Cantonese, Japanese, Korean, Malay, French, Spanish, and Tamil. Opening a phrase exposes individual characters for Mandarin, Cantonese, and Japanese, or individual words for the other languages. These study units can be saved and each language remembers its pronunciation-guide preference. Standard guides include Pinyin, Jyutping, Hiragana, Korean romanization, and Tamil transliteration, while every language also includes an English-friendly phonetic option. The lesson setup and full interface can be displayed in any of the nine languages. The clips can be regenerated with the existing Azure Speech resource without exposing its key to the browser:
